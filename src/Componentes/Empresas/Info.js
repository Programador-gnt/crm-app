...
import { CssBaseline, Grid, Backdrop, Card, CardContent, CardActions, Avatar, Typography, Divider, IconButton, Chip } from '@material-ui/core';
					...
					<SpeedDial
						...
						{actions.map(action => (
							<SpeedDialAction
								...
								onClick={action.name === 'Volver' ? () => props.history.push('/empresas') : ''}
							/>
						))}
					</SpeedDial>

    ...
    handlePrimaryColorChange = (event) => {
        ...
        this.setState({
            ...
            theming.changeTheme({
                ...
                this.props.openSnackbar('Color primario cambiado');
            }).catch((reason) => {
    ...
    handleSecondaryColorChange = (event) => {
        ...
        this.setState({
            ...
            theming.changeTheme({
                ...
                this.props.openSnackbar('Color secundario cambiado');
            }).catch((reason) => {
                const code = reason.code;
                const message = reason.message;
    ...
    handleTypeChange = (event) => {
        ...
        this.setState({
            ...
            theming.changeTheme({
                ...
                this.props.openSnackbar('Estilo cambiado');
            }).catch((reason) => {
                const code = reason.code;
                const message = reason.message;
    ...
    handleResetClick = () => {
        ...
        this.setState({
            ...
            theming.resetTheme().then((value) => {
                this.props.openSnackbar('Reseteado');
            }).catch((reason) => {
                const code = reason.code;
                const message = reason.message;
            ...
            <DialogContent>
                <List disablePadding>
                    ...
                    <ListItem>
                        ...
                        <ListItemText
                            primary="Reset tema"
                            secondary="Los cambios serán revertidos"
                        />
